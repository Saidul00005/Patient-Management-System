...
class CustomUser(AbstractUser):
    ...
    user_role = models.CharField(max_length=100, choices=SUPERVISION_CHOICES)
    ...
    gender = EncryptedCharField(
        max_length=1, blank=True, choices=GENDER_CHOICE, null=True
    )
    ...
    gdpr_ip = EncryptedCharField(max_length=100, blank=True, null=True)
    gdpr_agreement_date = EncryptedDateField(null=True, blank=True)
